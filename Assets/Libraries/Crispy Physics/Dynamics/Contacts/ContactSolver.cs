    ...
    public class ContactSolver
    {
            ...
            Position[] positions, Velocity[] velocities)
        {
            ...
            for (uint i = 0; i < count; i++)
            {
                ...
                Debug.Assert(contact.internalFirstBody != null);
                Debug.Assert(contact.internalSecondBody != null);
                Debug.Assert(contact.internalFirstBody.shape != null);
                Debug.Assert(contact.internalSecondBody.shape != null);
                ...
                vc.indexA = firstBody.islandIndex;
                vc.indexB = secondBody.islandIndex;
                vc.invMassA = firstBody.invMass;
                vc.invMassB = secondBody.invMass;
                vc.invIA = firstBody.invRotationalInertia;
                vc.invIB = secondBody.invRotationalInertia;
                vc.contactIndex = i;
                vc.K = Matrix2x2.zero;
                ...
                pc.indexA = firstBody.islandIndex;
                pc.indexB = secondBody.islandIndex;
                pc.invMassA = firstBody.invMass;
                pc.invMassB = secondBody.invMass;
                pc.centerA = firstBody.center;
                pc.centerB = secondBody.center;
                pc.invIA = firstBody.invRotationalInertia;
                pc.invIB = secondBody.invRotationalInertia;
